...
import { AwardIcon, ChevronRightIcon } from "@/components/svg-icons";
    ...
    <section className="flex flex-col items-center justify-center py-10 md:py-20 relative overflow-hidden">
      ...
      >
        ...
        <div className="relative w-full">
          <div
            ref={scrollRef}
            className="flex sm:grid sm:grid-cols-3 gap-4 overflow-x-auto sm:overflow-visible scroll-smooth w-full pb-2"
          >
            {AWARDS.map((award, i) => (
              <motion.div
                key={i}
                ...
                className="shrink-0 w-[80vw] sm:w-auto sm:shrink p-5 rounded-lg bg-[#0300145e] border border-[#7042f88b] backdrop-blur-sm text-center"
              >
