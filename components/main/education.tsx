      ...
      <div className="flex flex-wrap justify-center gap-8 mt-12 max-w-5xl px-6">
        {EDUCATION.map((edu, index) => (
          <motion.div
            ...
            className="w-full max-w-lg p-8 rounded-2xl border border-white/10 bg-white/[0.02] hover:border-purple-500/30 transition-all duration-500 relative overflow-hidden group"
          >
