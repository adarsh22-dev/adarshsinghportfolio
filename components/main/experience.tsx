          ...
          <div className="flex flex-col gap-16">
            ...
            <div className="flex md:hidden items-center justify-center gap-4 -mt-8 mb-2">
              ...
              <span className="text-xs text-gray-500 font-mono">
                {mobileIndex + 1} / {EXPERIENCES.length}
              </span>

              <button
                onClick={() => setMobileIndex((i) => Math.min(EXPERIENCES.length - 1, i + 1))}
            ...
            {EXPERIENCES.map((exp, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`flex flex-col md:flex-row items-start w-full group relative ${isMobileVisible ? "" : "hidden md:flex"}`}
                >
